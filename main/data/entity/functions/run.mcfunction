...
execute if entity @s[type=marker] run function entity:marker/run
...
execute if entity @s[type=boat,tag=,predicate=!minecraft:dimension/overworld,predicate=!dimension/cmp] run kill @s
execute if entity @s[type=boat] run function entity:boat/run


execute if entity @s[type=minecraft:tnt] run function antigrief:run
