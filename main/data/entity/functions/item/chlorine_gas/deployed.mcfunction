...
execute as @a[gamemode=!creative,gamemode=!spectator,scores={DeathTime=0},nbt={HurtTime:0s},distance=..5] at @s unless entity @s[predicate=race/flora,advancements={races/flora/2=true}] run function entity:item/chlorine_gas/player
