...
execute if entity @s[predicate=dimension/overworld,predicate=!biome/mushroom_fields,nbt={Item:{id:"minecraft:spawner"},OnGround:1b}] if data entity @s Thrower if block ~ ~ ~ air run function entity:item/spawners/check
