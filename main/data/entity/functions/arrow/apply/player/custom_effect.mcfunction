...
execute unless data storage minecraft:player data.DisabledUpgrades[{id:1}] if entity @s[predicate=minecraft:race/arthropod,advancements={minecraft:races/arthropod/1=true}] as @e[type=#arrows,tag=selectorArrow,limit=1] run function entity:arrow/apply/ensnaring
