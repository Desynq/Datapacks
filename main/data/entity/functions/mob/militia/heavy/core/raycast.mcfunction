execute positioned ~ ~-1.8 ~ if entity @a[team=!militia,gamemode=!creative,gamemode=!spectator,distance=..3] at @s run function entity:mob/militia/heavy/core/fire
...
execute unless entity @s[scores={despawn.timer=64..}] positioned ^ ^ ^1 run function entity:mob/militia/heavy/core/raycast
