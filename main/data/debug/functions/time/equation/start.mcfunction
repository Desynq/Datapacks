...
scoreboard players set limit rng 100
function math:rng
scoreboard players operation c daily_equation = output rng

tellraw @a [{"color":"gray","text":"|> "},{"score":{"name":"a","objective":"daily_equation"}}," + ",{"score":{"name":"b","objective":"daily_equation"}}," * ",{"score":{"name":"c","objective":"daily_equation"}}," = ?"]
...
scoreboard players operation b daily_equation *= c daily_equation
