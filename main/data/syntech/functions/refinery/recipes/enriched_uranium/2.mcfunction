...
replaceitem entity @s container.3 white_dye{CustomModelData:16,type:uranium_235,Tags:["radioactive"],display:{Name:'{"italic":"false","color":"dark_green","text":"Uranium 235"}'}} 2
replaceitem entity @s container.4 lava_bucket{type:nuclear_waste,Tags:["radioactive"],display:{Name:'{"italic":"false","text":"Nuclear Waste"}'}}