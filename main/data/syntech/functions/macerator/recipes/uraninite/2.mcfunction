...
item replace entity @s container.4 with white_dye{CustomModelData:17,type:crushed_uraninite,display:{Name:'{"italic":"false","text":"Crushed Uraninite"}',Lore:['{"italic":"false","color":"gray","text":"○ Can be washed to remove impurities"}','{"italic":"false","color":"aqua","text":"○ ???"}']}}
