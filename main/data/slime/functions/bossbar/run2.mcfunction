...
execute if entity @s[type=player] run bossbar set bosshp name [{"color":"gray","text":"???"},{"color":"red","text":" ["},{"color":"red","score":{"objective":"bossbar_values","name":"current_hp"}},{"color":"red","text":"/"},{"color":"red","score":{"objective":"bossbar_values","name":"max_hp"}},{"color":"red","text":"]"}]
