...
title @s subtitle [{"color":"dark_aqua","score":{"objective":"antiair","name":"@s"}},{"color":"dark_aqua","text":"/40"}]

execute if entity @s[scores={antiair=10}] run playsound entity.elder_guardian.curse master @s ~ ~ ~ 2147483647
execute if entity @s[scores={antiair=25}] run playsound entity.elder_guardian.curse master @s ~ ~ ~ 2147483647
execute if entity @s[scores={antiair=40}] run playsound entity.elder_guardian.curse master @s ~ ~ ~ 2147483647

execute if entity @s[scores={antiair=40..}] run function slime:antiair/kill
