summon iron_golem ~ ~ ~ {Tags:["patrol","boss"],CustomName:'{"color":"gray","text":"Patrol Helicopter"}',Health:2147483647,Attributes:[{Name:generic.max_health,Base:2147483647}],NoGravity:1}
