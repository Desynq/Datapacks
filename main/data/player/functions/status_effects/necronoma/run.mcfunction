...
scoreboard players reset @s[scores={ateRottenFlesh=1..,timer.necro=..4000}] timer.necro
scoreboard players remove @s[scores={ateRottenFlesh=1..,timer.necro=4000..}] timer.necro 4000
