...
execute if entity @s[advancements={races/flora/1/2=true}] run effect give @a[distance=..16,scores={regen_amp=0..1}] regeneration 5 2 true
execute if entity @s[advancements={races/flora/1/3=true}] run effect give @a[distance=..16] resistance 5 2 true
