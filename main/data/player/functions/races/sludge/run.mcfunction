...
execute if score 600 tick matches 600 run effect give @s[advancements={races/sludge/3/2=true,races/sludge/3/2/1=false}] saturation 1 0 true
execute if score 300 tick matches 300 run effect give @s[advancements={races/sludge/3/2/1=true}] saturation 1 0 true
