...
execute if entity @s[predicate=race/sludge,scores={raceUpgrade=21,slime=5000..},advancements={races/sludge/2=true,races/sludge/2/1=false}] run function player:races/upgrading/sludge/21
