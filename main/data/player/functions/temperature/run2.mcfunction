...
execute if score season timer matches 3 if score 10 tick matches 10 if entity @s[predicate=!light/0-12] if score @s temperature matches ..49 run function player:temperature/raise
...
execute if score season timer matches 3 if score 10 tick matches 10 if score @s temperature matches 36.. if entity @s[predicate=light/0-12] if score ice_cube durability matches 1.. if data storage minecraft:inventory baubles[0].tag{type:"ice_cube_hat"} run scoreboard players remove @s temperature 1
execute if score season timer matches 3 if score 10 tick matches 10 if score @s temperature matches 36.. if entity @s[predicate=light/0-12] if score ice_cube durability matches 1.. unless data storage minecraft:inventory baubles[0].tag{type:"ice_cube_hat"} if data storage minecraft:inventory baubles[1].tag{type:"ice_cube_hat"} run scoreboard players remove @s temperature 1
...
execute if score season timer matches 1 if score 20 tick matches 20 if score @s temperature matches 1.. if data storage minecraft:inventory baubles[0].tag{type:"ice_cube_hat"} run scoreboard players remove @s temperature 1
execute if score season timer matches 1 if score 20 tick matches 20 if score @s temperature matches 1.. unless data storage minecraft:inventory baubles[0].tag{type:"ice_cube_hat"} if data storage minecraft:inventory baubles[1].tag{type:"ice_cube_hat"} run scoreboard players remove @s temperature 1
