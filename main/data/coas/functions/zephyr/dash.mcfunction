...
execute if entity @s[predicate=equipment/mainhand/zephyr] as @e[type=#mob,type=!#undead,distance=..2] unless score @s list = @p list run effect give @s instant_damage 1 0 true
execute if entity @s[predicate=equipment/mainhand/ultimatum] as @e[type=#mob,type=!#undead,distance=..2] unless score @s list = @p list run effect give @s instant_damage 1 1 true
...
execute if entity @s[predicate=equipment/mainhand/zephyr] run effect give @e[type=#undead,distance=..2] instant_health 1 0 true
execute if entity @s[predicate=equipment/mainhand/ultimatum] run effect give @e[type=#undead,distance=..2] instant_health 1 1 true
