...
execute if entity @s[predicate=entity:equipment/mainhand/coas/zephyr] as @e[type=#mob,type=!#undead,distance=..2] unless score @s list = @p list run effect give @s instant_damage 1 0 true
execute if entity @s[predicate=entity:equipment/mainhand/coas/ultimatum] as @e[type=#mob,type=!#undead,distance=..2] unless score @s list = @p list run effect give @s instant_damage 1 1 true
...
execute if entity @s[predicate=entity:equipment/mainhand/coas/zephyr] run effect give @e[type=#undead,distance=..2] instant_health 1 0 true
execute if entity @s[predicate=entity:equipment/mainhand/coas/ultimatum] run effect give @e[type=#undead,distance=..2] instant_health 1 1 true
