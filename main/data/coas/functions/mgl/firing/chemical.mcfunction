...
summon item ~ ~1.75 ~ {Tags:["mgl.bullet"],PickupDelay:32767,Invulnerable:1,Glowing:1,Item:{id:firework_star,Count:1,tag:{type:chlorine_gas_grenade,Explosion:{Colors:[I;11250603,14602026]}}}}
