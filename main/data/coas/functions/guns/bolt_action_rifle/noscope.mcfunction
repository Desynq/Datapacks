...
scoreboard players set limit rng 2025
function math:rng
...
execute rotated as @e[type=area_effect_cloud,tag=bullet.spread_vector,limit=1] run function coas:guns/bolt_action_rifle/firing
