...
execute in overworld run data modify block 0 0 0 Text1 set value '[{"italic":"false","color":"gray","score":{"objective":"a.m14","name":"@a[tag=unloading]"}},{"italic":"false","color":"gray","text":"/20 Remaining"}]'
