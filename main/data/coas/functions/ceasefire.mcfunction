...
execute unless score ran temp matches 1 store success score ran temp run execute if entity @s[scores={ammo=1..},predicate=equipment/mainhand/coas/gun/minigun]
