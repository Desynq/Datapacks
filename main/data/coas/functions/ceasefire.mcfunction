...
execute unless score ran temp matches 1 store success score ran temp run execute if entity @s[scores={xp=3..,sneak=1},predicate=equipment/mainhand/coas/mining_laser]
