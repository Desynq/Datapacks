...
execute if entity @s[tag=unplace] run function postrun:entity/item_frame/tool_cupboard/unplace
execute if entity @s[tag=!unplace] if block ^ ^ ^-1 #indestructible run function postrun:entity/item_frame/tool_cupboard/unplace