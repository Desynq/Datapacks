### Auto-Despawn ###
	execute if entity @s[type=#nospawn,tag=] run function postrun:entity/mob/auto_despawn
	
### Teams ###
	execute if entity @s[team=] run function postrun:entity/mob/join_team


execute if entity @s[scores={t.airblast=1..}] run function postrun:entity/mob/airblast




execute if entity @s[predicate=effects/luck_1] run function postrun:entity/custom/he_arrow
...
execute if entity @s[type=cave_spider,predicate=dimension/overworld,nbt={HurtTime:10s}] align xyz run function slime:spider
...
execute if entity @s[type=pillager] run function postrun:entity/mob/illager
...
### Militia ###
	execute if entity @s[type=husk,tag=militia.heavy] if entity @a[gamemode=!creative,gamemode=!spectator,distance=..64] run function postrun:entity/mob/militia/heavy/run
...
execute if score stopwatch timer matches 1.. if entity @s[tag=!boss,tag=!frozen,nbt=!{NoAI:1b}] run function postrun:entity/mob/stopwatch/freeze
execute unless score stopwatch timer matches 1.. if entity @s[tag=!boss,tag=frozen] run function postrun:entity/mob/stopwatch/unfreeze