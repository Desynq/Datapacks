...
execute if entity @s[gamemode=!spectator,gamemode=!creative,predicate=dimension/overworld,tag=!scp] run function prerun:player/temperature/run2
...
execute if entity @s[scores={player.hp=..5,timeSinceDeath=20..,temperature=0},tag=!dead] run function prerun:player/temperature/frostbite
