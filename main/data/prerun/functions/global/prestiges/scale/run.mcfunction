...
execute as @e[type=#mob,type=!player,tag=,scores={ent.hp_init=1..,ent.dmg_init=1..},predicate=dimension/overworld] unless score @s ent.scaled = avg temp run function prerun:global/prestiges/scale/entity