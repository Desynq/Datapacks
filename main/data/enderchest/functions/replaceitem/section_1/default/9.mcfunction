execute in overworld run item replace block 0 0 1 container.0 with green_stained_glass{type:buy_stat,Tags:["custom"],display:{Name:'{"italic":"false","underlined":"true","color":"dark_green","text":"Buy Attribute"}',Lore:['""']}}
...
execute in overworld run item replace entity @s enderchest.9 from block 0 0 1 container.0
