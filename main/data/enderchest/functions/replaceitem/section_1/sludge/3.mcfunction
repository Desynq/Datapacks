execute in overworld run replaceitem block 0 0 1 container.0 apple{Tags:["custom"],type:stat_health,display:{Name:'{"italic":"false","color":"red","text":"Max Health (+4)"}',Lore:['""']}}
	tag @s add temp
