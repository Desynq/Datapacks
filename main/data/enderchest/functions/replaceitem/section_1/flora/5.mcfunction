execute in overworld run item replace block 0 0 1 container.0 with rabbit_foot{Tags:["custom"],type:stat_luck,display:{Name:'{"italic":"false","color":"green","text":"Luck (+4)"}',Lore:['""']}}
	tag @s add temp
