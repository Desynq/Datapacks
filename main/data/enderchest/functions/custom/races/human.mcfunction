...
advancement grant @s only races/human/root
...
playsound minecraft:entity.player.hurt master @s ~ ~ ~ 2147483647 0.5


tellraw @s [{"color":"gray","text":"You quickly morph into a "},{"bold":"true","text":"Human"}]
