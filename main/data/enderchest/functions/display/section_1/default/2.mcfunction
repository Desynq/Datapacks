execute in minecraft:overworld run item replace block 0 0 1 container.0 with golden_pickaxe{Tags:["custom"],type:stat_swing,display:{Name:'{"italic":"false","color":"yellow","text":"Attack Speed (+0.2)"}',Lore:['""']},AttributeModifiers:[]}
	tag @s add temp
