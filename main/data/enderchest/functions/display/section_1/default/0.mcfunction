execute in overworld run item replace block 0 0 1 container.0 with yellow_stained_glass{type:reset_stats,Tags:["custom"],display:{Name:'{"italic":"false","underlined":"true","color":"yellow","text":"Attribute Information"}',Lore:['""','""','""','""','""','""','{"italic":"false","color":"dark_green","text":"Shift-Click To Reset Attributes"}']}}
...
execute in overworld run item replace entity @s enderchest.0 from block 0 0 1 container.0
