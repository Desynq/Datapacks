...
execute positioned ~ ~-1 ~ as @a[distance=..1,gamemode=!creative,gamemode=!spectator,tag=!dead,predicate=!equipment/offhand/soulwalker_shield] at @s run function myst:mobs/rift_mage/spells/spikes/kill_player