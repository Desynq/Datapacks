...
execute in slime:vietnam run summon guardian -114.0 241 76.0 {PersistenceRequired:1,Tags:["eldritch_eye.hitbox","boss"],NoAI:1,Health:10000,Attributes:[{Name:generic.max_health,Base:10000}],ActiveEffects:[{Id:14,Duration:2147483647,ShowParticles:0b}]}