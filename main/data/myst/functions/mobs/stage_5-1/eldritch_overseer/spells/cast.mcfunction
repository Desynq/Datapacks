...
execute if score output rng matches 0 if entity @a[gamemode=!creative,gamemode=!spectator,nbt={DeathTime:0s},distance=..64] run function myst:mobs/stage_5-1/eldritch_overseer/spells/shulker_bullet
execute if score output rng matches 0 if entity @a[gamemode=!creative,gamemode=!spectator,nbt={DeathTime:0s},distance=..64] run function myst:mobs/stage_5-1/eldritch_overseer/spells/shulker_bullet
execute if score output rng matches 0 if entity @a[gamemode=!creative,gamemode=!spectator,nbt={DeathTime:0s},distance=..64] run function myst:mobs/stage_5-1/eldritch_overseer/spells/shulker_bullet
