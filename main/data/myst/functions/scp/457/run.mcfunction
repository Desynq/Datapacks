...
execute if score 100 tick matches 100 if entity @a[distance=..64,gamemode=!creative,gamemode=!spectator] run summon zombified_piglin ~ ~ ~ {HandItems:[{id:golden_sword,Count:1}],DeathLootTable:"",AngerTime:2147483647,Health:100,Attributes:[{Name:generic.max_health,Base:100}]}
