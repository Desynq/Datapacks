...
execute in slime:themyst as @p[gamemode=adventure,tag=!dead,distance=0..,tag=!myst_spawn] facing entity @s[distance=..3] feet as @e[type=armor_stand,tag=scp106] run tp ^ ^ ^.05
execute in slime:themyst as @p[gamemode=adventure,tag=!dead,distance=0..,tag=!myst_spawn] facing entity @s[distance=3..20] feet as @e[type=armor_stand,tag=scp106] run tp ^ ^ ^.1
execute in slime:themyst as @p[gamemode=adventure,tag=!dead,distance=0..,tag=!myst_spawn] facing entity @s[distance=20..] feet as @e[type=armor_stand,tag=scp106] run tp ^ ^ ^.5
...
execute as @a[distance=..1,gamemode=adventure,tag=!dead,tag=!myst_spawn] run function myst:scp/106/kill_player
