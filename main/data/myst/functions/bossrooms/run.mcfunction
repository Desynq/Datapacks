...
execute in slime:themyst positioned -126 54 69 if score 1 reactor matches 25.. run particle soul_fire_flame ~ ~.5 ~ .50 .50 .50 .05 10 normal @a
execute in slime:themyst positioned -110 54 69 if score 2 reactor matches 25.. run particle soul_fire_flame ~ ~.5 ~ .50 .50 .50 .05 10 normal @a
execute in slime:themyst positioned -110 54 85 if score 3 reactor matches 25.. run particle soul_fire_flame ~ ~.5 ~ .50 .50 .50 .05 10 normal @a
execute in slime:themyst positioned -126 54 85 if score 4 reactor matches 25.. run particle soul_fire_flame ~ ~.5 ~ .50 .50 .50 .05 10 normal @a
