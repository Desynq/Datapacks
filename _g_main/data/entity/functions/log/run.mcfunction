...
execute if entity @s[type=minecraft:giant,tag=] run function entity:shared/despawn

execute if entity @s[type=minecraft:bat,tag=,predicate=!minecraft:dimension/overworld] run function entity:shared/despawn
