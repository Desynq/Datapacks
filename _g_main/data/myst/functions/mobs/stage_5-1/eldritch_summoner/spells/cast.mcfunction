...
execute if score output rng matches 0 if entity @a[gamemode=!creative,gamemode=!spectator,scores={DeathTime=0},distance=..64] at @e[type=wither_skeleton,tag=eldritch_summoner] run function myst:mobs/stage_5-1/eldritch_summoner/spells/shulker_bullet
