...
effect give @s[predicate=entity:equipment/mainhand/ender_bow] slow_falling 2048 0 true
...
effect give @s[predicate=entity:equipment/chest/absorbing_chainmail] minecraft:absorption 2048 0 true
effect give @s[predicate=race/sludge,predicate=entity:equipment/chest/sticky_chestplate] minecraft:absorption 2048 1 true
effect give @s[predicate=race/creep,predicate=entity:equipment/chest/creeping_chestplate] minecraft:absorption 2048 0 true
