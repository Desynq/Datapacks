...
execute store result score @s located as @a if score @p pln_forward = @s list facing entity @s feet rotated ~ 0 run particle minecraft:dust 1 0 0 1 ^ ^1.8 ^2 0 0 0 0 1 force @p
