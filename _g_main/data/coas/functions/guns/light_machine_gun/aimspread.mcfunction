...
execute unless score limit rng matches 0..6000 run scoreboard players set limit rng 6000
...
execute rotated as @e[type=area_effect_cloud,tag=bullet.spread_vector,limit=1] run function coas:guns/light_machine_gun/firing
