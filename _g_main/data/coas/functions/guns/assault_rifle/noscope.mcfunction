...
execute if score limit rng matches 6824.. run scoreboard players set limit rng 6823
...
execute rotated as @e[type=area_effect_cloud,tag=bullet.spread_vector,limit=1] run function coas:guns/assault_rifle/firing/mundane
