...
advancement grant @s only races/parasite/root
...
playsound minecraft:entity.silverfish.hurt master @s ~ ~ ~ 2147483647 0.5


tellraw @s [{"color":"gray","text":"You quickly morph into a "},{"bold":"true","text":"Parasite"}]
